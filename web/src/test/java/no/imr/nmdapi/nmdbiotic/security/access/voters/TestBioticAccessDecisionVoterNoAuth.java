...
import no.imr.nmdapi.nmdbiotic.security.access.voters.TestBioticAccessDecisionVoterNoAuth.Init;
...
public class TestBioticAccessDecisionVoterNoAuth {
    ...
    public void testNotBioticUrl() {
        ...
        assertEquals(ACCESS_ABSTAIN, bioticAccessDecisionVoter.vote(auth, filter, confAttr));
    }
